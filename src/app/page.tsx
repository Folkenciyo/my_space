...
export default function Home() {
  ...
  return (
    <div className="min-h-screen dynamic-background text-gray-300 relative overflow-hidden">
      <div className="fixed top-4  md:left-4 flex md:space-x-4 bg-gray-800 text-white px-4 py-2 rounded-full shadow-lg opacity-75 hover:opacity-100 transition-opacity z-50 pointer-events-auto">
      ...
      <div
        className="z-50 pointer-events-auto fixed top-4 right-4 bg-gray-800 text-white px-4 py-2 rounded-full shadow-lg opacity-75 hover:opacity-100 transition-opacity cursor-pointer hidden md:block"
        onClick={handleCopy}
      >
        {copied ? "Copied!" : "juanguerrero.dev@gmail.com"}
      </div>
          ...
          <div className="flex flex-col items-center space-y-4 mt-8">
            ...
            <div className="flex items-center space-x-2">
              <a
                ...
                className="z-50 pointer-events-auto px-4 py-2 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition-colors"
              >
                Enviar Email
              </a>
              <button
